  ...
  const slides = [
    {
      ...
      btn1: "SHOP NOW",
      btn2: "LEARN MORE",
      btn1Navigate: "/shop",  // Added navigation path for btn1
      btn2Navigate: "/about", // Added navigation path for btn2
    },
    {
      ...
      btn2: "FREE DELIVERY",
      btn1Navigate: "/shop",  // Added navigation path for btn1
      btn2Navigate: "/delivery", // Added navigation path for btn2
    },
    {
      ...
      btn2: "SPECIAL DEALS",
      btn1Navigate: "/shop",  // Added navigation path for btn1
      btn2Navigate: "/deals", // Added navigation path for btn2
    },
  ];
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-5 mt-10">
                <motion.button
                  ...
                  onClick={() => navigate(slide.btn1Navigate)} // ADDED NAVIGATION
                >
                  {slide.btn1}
                </motion.button>
                <motion.button
                  ...
                  onClick={() => navigate(slide.btn2Navigate)} // ADDED NAVIGATION
                >
                  {slide.btn2}
                </motion.button>
              </div>
